...
// ErrInvalidByte means that a given byte is outside the GSM 7-bit encoding range.
//
...
// ValidateGSM7Buffer Returns the bytes, in the given buffer, that are outside the GSM 7-bit encoding range.
